    ...
    public function __invoke(Request $request): WeeklyNewsletterMail
    {
        ...
        $weekendEvents = [
            ...
            new Event([
                ...
                'image_url' => '/img/landing/night-market.webp',
            ...
            new Event([
                ...
                'image_url' => '/img/landing/concert-crowd.webp',
                'category' => 'concerts',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
        ...
        $weekEvents = [
            ...
            new Event([
                ...
                'image_url' => '/img/landing/theatre-stage.webp',
                'category' => 'theatre',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
        ...
        $comingSoonEvents = [
            new Event([
                ...
                'image_url' => '/img/landing/easter-eggs.webp',
                'category' => 'family-days-out',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
            ...
            new Event([
                ...
                'image_url' => '/img/landing/sunset-hike.webp',
                'category' => 'hiking',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
            ...
            new Event([
                ...
                'image_url' => '/img/landing/park-run.webp',
                'category' => 'fitness',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
            ...
            new Event([
                ...
                'image_url' => '/img/landing/sound-bath.webp',
                'category' => 'wellness',
                'url' => 'https://example.com',
                'matched_interest_ids' => [],
                'score_manual' => 0,
